      ...
      <form className={styles.form} onSubmit={handleSubmit}>
          ...
          <div className={styles.formGroup}>
            ...
            {formData.password && (
              <div style={{ marginTop: '0.5rem' }}>
                    ...
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor: i <= passwordStrength.strength ?
                          ['#e74c3c', '#e67e22', '#f1c40f', '#2ecc71', '#27ae60'][i - 1] :
                          '#ecf0f1',
                        borderRadius: '2px'
                      }}
                    />
                ...
                <span style={{
                  fontSize: '0.8rem',
                  color: passwordStrength.strength >= 4 ? '#27ae60' :
                    passwordStrength.strength >= 3 ? '#f1c40f' : '#e74c3c'
                }}>
        ...
        <div style={{
          ...
          <ul style={{ margin: '0.5rem 0 0 1rem', padding: 0 }}>
            <li style={{ color: formData.password.length >= 8 ? '#27ae60' : '#7f8c8d' }}>
              At least 8 characters
            </li>
            <li style={{ color: /[a-z]/.test(formData.password) ? '#27ae60' : '#7f8c8d' }}>
              One lowercase letter
            </li>
            <li style={{ color: /[A-Z]/.test(formData.password) ? '#27ae60' : '#7f8c8d' }}>
              One uppercase letter
            </li>
            <li style={{ color: /[0-9]/.test(formData.password) ? '#27ae60' : '#7f8c8d' }}>
              One number
            </li>
          </ul>
        </div>
